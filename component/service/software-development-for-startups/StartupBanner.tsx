        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex gap-10">
              <div>
                <p className="text-[50px] font-bold text-[#515253]">15+</p>
                <p className="text-gray-500 text-sm">Years Experience</p>
              </div>
              
              <div>
                <p className="text-[50px] font-bold text-[#515253]">200+</p>
                <p className="text-gray-500 text-sm">Projects Delivered</p>
              </div>

              <div>
                <p className="text-[50px] font-bold  text-[#515253]">20+</p>
                <p className="text-gray-500 text-sm">Successful launches</p>
              </div>
            </div>
          </div>

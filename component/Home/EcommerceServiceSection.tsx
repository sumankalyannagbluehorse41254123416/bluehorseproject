      ...
      <div className="container">
        ...
        <div className="flex">
          <p className="mt-6  text-base leading-8 text-white/90">
            sted by 200+ brands, we specialize in eCommerce solutions that deliver real results and measurable growth. By leveraging cutting-edge technologies, we offer tailored eCommerce development services designed to elevate your digital presence and unlock new opportunities.
            <a
              href="#"
            ...
            >
              ...
              <span className="transition-transform duration-300 ease-in-out group-hover:rotate-45 text-[15px]">
                ↗
              </span>
            </a>
        ...
        <div className="grid lg:grid-cols-3 mt-16">
          {services.map((item, i) => (
            <div
              key={item.title}
              className={`px-8 ${i !== services.length - 1

  ...
  return (
    <section className="relative grid lg:grid-cols-[35%_65%]">
      ...
      <div className="relative">
        ...
        {/* FLOAT CARD */}
        <div className="relative lg:absolute lg:-right-75 lg:top-1/2 lg:-translate-y-1/2 bg-white rounded-xl shadow-xl w-full lg:w-95 p-8 z-10">
          ...
          <span className="hidden lg:block absolute -left-2.5 top-1/2 -translate-y-1/2 w-5 h-5 bg-blue-600 rotate-45"></span>
      ...
      >
        <form className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6 lg:pl-93.75 lg:pt-18.75 lg:pb-18.75 lg:pr-18.75">
          ...
          <div className="md:col-span-2">
            ...
            <textarea rows={6} className="w-full px-4 py-3 rounded-lg bg-white/60 backdrop-blur-md border-2 border-white outline-none"/>
          </div>

          <button className="md:col-span-2 w-full h-[60px] bg-[#1f7db6] text-white text-xl rounded-lg hover:bg-[#166a9a] transition">
            Send
          </button>
